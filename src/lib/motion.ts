/*
 * Motion spec — copiado NA ÍNTEGRA de docs/DESIGN_SYSTEM.md §8.
 * Três curvas, sem improviso: spring (entre duas posições conhecidas),
 * emphasis (o que chega) e exit (o que sai, sempre mais rápido).
 */
...
/* ==========================================================================
 * Acréscimos deste projeto (fora do documento de origem)
 * ========================================================================== */

/**
 * Drawer que entra pela esquerda — a navegação no celular. Mesmas curvas do
 * drawerVariants, espelhadas: a folha nasce do lado de onde a sidebar vive.
 */
